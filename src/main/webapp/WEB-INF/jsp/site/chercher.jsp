				...
				<div class="uk-width-1-1">
					<div class="uk-flex uk-flex-bottom">
						<div class="uk-light uk-position-relative uk-text-left page-title">
							<h1 class="uk-margin-remove">Les Chambres</h1><!-- page title -->
			...
			<div class="uk-container">
				...
				<div class="uk-position-relative uk-visible-toggle uk-margin-small-top">
			        <ul class="uk-child-width-1-2@xl uk-child-width-1-2@l uk-child-width-1-2@m uk-child-width-1-1@s data-uk-grid uk-grid-match uk-margin-large-bottom"  data-uk-grid>
						...
						select distinct c.id_chambre,i.image,raison_social,c.description,c.prix from chambre c,hotel h, image_chambre i where 
						c.id_hotel = h.id_hotel && i.id_chambre = c.id_chambre
						&& (h.raison_social like '%${param.raison_social }%' && etoiles  = ${param.nombre_etoile} && ville like '%${param.ville}%' && pays like '%${param.pays}%')
						</sql:query>
				...
				<div class="uk-flex uk-flex-center" data-uk-grid>
					<div class="uk-width-1-1">
						<div class="impx-hp-booking-form hp2 no-margin">
							<h6 class="uk-heading-line uk-text-center impx-text-white uk-text-uppercase"><span>Chercher maintenant ! </span></h6>
							<form
