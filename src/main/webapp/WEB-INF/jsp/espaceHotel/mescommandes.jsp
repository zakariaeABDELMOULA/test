...
<head>
    ...
    <body id="impx-body">
		...
		<sql:query var="rshotel" dataSource="${db}">
			...
			where c.id_hotel = h.id_hotel && c.id_chambre=r.id_chambre && p.id_personne = r.id_personne && h.id_hotel = ${sessionScope.hotel.id_hotel }
		</sql:query>
                                        ...
                                        <tbody>
												<c:forEach var="cls" items="${rshotel.rows}">
								                   	<tr>
		                                                ...
		                                                <td>${cls.etat}</td>
		                                                <td>
				                                            <a data-toggle="tooltip" title="Edit" href="validerReservation?id_reservation=${cls.id_reservation}" class="pd-setting-ed btn btn-success">
				                                                Valider
				                                            </a>
				                                        </td>
		                                            </tr>
