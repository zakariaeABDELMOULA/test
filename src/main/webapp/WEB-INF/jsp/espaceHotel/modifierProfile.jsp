...
<html lang="en">
<head>
<title>Môdifier vos inforamtions</title>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="POST"
					...
					<div>
						<img src="${ sessionScope.hotel.image}" class="img-responsive img-thumbnail" alt="Cinque Terre" width="304" height="236"> 
					</div>
					...
					<div class="wrap-input100 validate-input m-b-26"
						...
						<span class="label-input100">Raison sociale : </span> <input requierd
							...
							placeholder="Enter Vôtre Raison Sociale " value="${sessionScope.hotel.raison_social }"> <span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-26"
						data-validate="Adresse is required">
						<span class="label-input100">Adresse</span> <input requierd  value="${sessionScope.hotel.adresse }"
					...
					<div class="wrap-input100 validate-input m-b-26"
						...
						<span class="label-input100">Qui êtes-vous : </span> <textarea rows="8" height="132px" requierd
							class="input100" type="text" id="description" name="description" 
							placeholder="description">${sessionScope.hotel.description }</textarea><span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-26"
						data-validate="date_creation is required">
						<span class="label-input100">Date de création : </span> <input requierd 
							class="input100" type="date" id="date_creation" value="<fmt:formatDate 
							pattern = 'yyyy-MM-dd' 
							value = '${sessionScope.hotel.date_creation }' />"
							name="date_creation" >
					...
					<div class="wrap-input100 validate-input m-b-26"
						...
						<span class="label-input100">Email : </span> <input requierd
							class="input100" type="text" id="email" name="email"  value="${sessionScope.hotel.email }"
					...
					<div class="wrap-input100 validate-input m-b-26"
						...
						<span class="label-input100">Pays</span> <input requierd
							class="input100" type="text" id="pays" name="pays"  value="${sessionScope.hotel.pays }"
							placeholder="Enter Pays"> <span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-26"
						data-validate="Pays is required">
						<span class="label-input100">Ville</span> <input requierd
							class="input100" type="text" id="ville" name="ville"  value="${sessionScope.hotel.ville }"
					...
					<div class="wrap-input100 validate-input m-b-26"
						...
						<span class="label-input100">Telephone</span> <input requierd
							class="input100" type="number" id="telephone" name="telephone"  value="${sessionScope.hotel.telephone }"
					...
					<div class="wrap-input100 validate-input m-b-26"
						...
						<span class="label-input100">etoiles</span> <input requierd
							class="input100" type="number" id="etoiles" name="etoiles"  value="${sessionScope.hotel.etoiles }"
...
$(document).ready(function () {
    ...
    var form = $('#fileUploadForm')[0];
        ...
        var jsonDataObj = {
        	"id_hotel" : ${sessionScope.hotel.id_hotel},	
        	"adresse": $("#adresse").val(),
        	"date_creation": $("#date_creation").val(),
        	"description": $("#description").val(),
        	"email": $("#email").val(),
        	"etoiles": $("#etoiles").val(),
            "password" : "${sessionScope.hotel.password}",
            "pays": $("#pays").val(),
            "raison_social": $("#raison_social").val(),
        	"telephone": $("#telephone").val(),
            "ville": $("#ville").val(),
            "image":"${sessionScope.hotel.image}",
        };
