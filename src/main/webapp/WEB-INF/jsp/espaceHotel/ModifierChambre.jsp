			...
			<form class="well form-horizontal" id="fileUploadForm" method="POST"
				...
				<input type="hidden" name="id_chambre" value="${param.id_chambre }" />
						<sql:query var="rshotel" dataSource="${db}">
							select * from chambre where id_chambre = ${param.id_chambre}
						</sql:query> 
                      <fieldset>
                      <c:forEach var="chambre" items="${rshotel.rows}">
                         <div class="form-group">
                            <label class="col-md-4 control-label">Description :</label>
                            <div class="col-md-4 inputGroupContainer">
                               <div class="input-group">
                               <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                               <input id="description" name="description" id="description" value="${chambre.description }" placeholder="Description"
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                               <div class="input-group">
                               	...
                               	class="form-control" required="true" type="text" value="${chambre.prix }"></div>
                            </div>
                         </div>
                         <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                               ...
                               <input  name="promo" id="promo" placeholder="Promotion" value="${chambre.promotion }" class="form-control"
                      ...
                      <div style="text-align:center"><input value="modifier" id="btnSubmit" class="btn btn-success"/></div>
                      
                      <div class="alert alert-success">Chambre Bien Modifiée</div>
